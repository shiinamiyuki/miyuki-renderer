...
namespace ImGui
{
    ...
    IMGUI_API void          SetNextWindowBgAlpha(float alpha);                                          // set next window background albedo alpha. helper to easily modify ImGuiCol_WindowBg/ChildBg/PopupBg. you may also use ImGuiWindowFlags_NoBackground.
...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags_NoSidePreview   = 1 << 8,   //              // ColorPicker: disable bigger albedo preview on right side of the picker, use small colored square preview instead.
