...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            ImGui::ColorEdit3("albedo 1", col1);
            ImGui::SameLine(); ShowHelpMarker("Click on the colored square to open a albedo picker.\nClick and hold to use drag and drop.\nRight-click on the colored square to show options.\nCTRL+click on individual component to input value.\n");

            ImGui::ColorEdit4("albedo 2", col2);
        }
    ...
    if (ImGui::TreeNode("Text"))
    {
        if (ImGui::TreeNode("Colored Text"))
        {
            ...
            ImGui::SameLine(); ShowHelpMarker("The TextDisabled albedo is stored in ImGuiStyle.");
            ImGui::TreePop();
        }
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::Checkbox("With Options Menu", &options_menu); ImGui::SameLine(); ShowHelpMarker("Right-click on the individual albedo widget to show options.");
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            ShowHelpMarker("In the albedo list:\nLeft-click on colored square to open albedo picker,\nRight-click to open edit options menu.");
            ...
            for (int i = 0; i < ImGuiCol_COUNT; i++)
            {
                ...
                if (!filter.PassFilter(name))
                    continue;
                ImGui::PushID(i);
                ImGui::ColorEdit4("##albedo", (float*)&style.Colors[i], ImGuiColorEditFlags_AlphaBar | alpha_flags);
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // Display every line as a separate entry so we can change their albedo or add custom widgets. If you only want raw text you can use ImGui::TextUnformatted(log.begin(), log.end());
        ...
        for (int i = 0; i < Items.Size; i++)
        {
            ...
            // Normally you would store more information in your item (e.g. make Items[] an array of structure, store albedo/type etc.)
...
struct MyDocument
{
    ...
    static void DisplayContents(MyDocument* doc)
    {
        ...
        if (ImGui::Button("Save", ImVec2(100, 0)))
            doc->DoSave();
        ImGui::ColorEdit3("albedo", &doc->Color.x);  // Useful to test drag and drop and hold-dragged-to-open-tab behavior.
        ImGui::PopID();
    }
